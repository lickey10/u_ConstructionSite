...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        public int CameraHeightOffsetZ = 0;
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position,new Vector3(m_Target.position.x + CameraFrontBackOffset, m_Target.position.y +CameraHeightOffset, m_Target.position.z + CameraHeightOffsetZ), deltaTime*m_MoveSpeed);
